package praktikum.modul1a.a1_prak1a_13020200002;
...
public class Activity2 extends AppCompatActivity {
    ...
    public void inputSelesai (View view) {
        ...
        intent.putExtra(MainActivity.KEY_NILAI_TUGAS, txtNilaiTugas.getText().toString()); intent.putExtra(MainActivity.KEY_NILAI_MID, txtNilaiMid.getText().toString());
